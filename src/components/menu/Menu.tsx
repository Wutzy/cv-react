    ...
    return (
        <div className='col s3 m3'>
            ...
            <div className='menu-desktop'>
                ...
                {menuItems.map(item => (
                    <div key={item.value} className={`menu-item ${item.isSelected ? 'selected' : ''}`}>
                        <Link className='grow' to={item.path} onClick={() => handleItemClick(item.value)}><i className='material-icons'>{item.icon}</i>{item.label}</Link>
                    </div>
                ))}
                <div className='social-media'>
                    <div className='grow'>
                        <Link to={`https://github.com/Wutzy`} target="_blank" className='github-logo'>
                            <svg width="50px" height="50px" viewBox="0 0 100 120" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='grow'>
                        <Link to={`https://www.linkedin.com/in/anis-matmati-8b192986/`} target="_blank" className='linkedin-logo'>
